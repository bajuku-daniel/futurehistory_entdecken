            ...
            success: function (data) {
                ...
                if (!tourdisplay_is_Active) {
                    ...
                    for (var item in marker_purchased) {
                        if(!hasPurchaseId(marker_purchased[item])){
...
// params - array of parameters to pass to function.
    ...
    function initializeRequestArgIndicator() {
        ...
        if (isArray(author) && author.length > 1 && (requestArgIndicatorClass.indexOf("author") ==-1)) {
            requestArgIndicatorClass = requestArgIndicatorClass + ' author';
        } else if (isArray(author) && author.length == 1 && (requestArgIndicatorClass.indexOf("author") ==-1)) {
            requestArgIndicatorClass = requestArgIndicatorClass + ' author';
        }
    ...
    function initializeAccordions() {
        ...
        $('#sammlungen_selector input').off('click');
...
var tourStash = [];
    ...
    function setUpdateTours(toursFilteredData) {
        ...
        // ist_tours?tour_id=all
        // TODO:REFACTOR call to list_tour_content not needed could be includet
        ...
        for (var i = 0; i < toursFilteredData.length; i++) {
            ...
            if (tourStash[toursItem.tour_id] !== undefined) {
                continue;
            }
            ...
            ajaxXHR["sut_" + i] = $.ajax({
                ...
                success: function (allTourDetails, i) {
                    ...
                    for (var key in allTourDetails) {
                        ...
                        var purchase_id = hasPurchaseId(tourdetails[0])?'hidden':'';
                        ...
                        var buildTourMarkup = function () {
                            ...
                            $(document).on('click', '#tour_selector .info', {}, function (e) {
